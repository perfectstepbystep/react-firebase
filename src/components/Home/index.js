...
class MessagesBase extends Component {
  ...
  onListenForMessages() {
    ...
    this.props.firebase.messages().orderByChild('createdA').limitToLast(this.state.limit)
      .on('value', snapshot => {
      ...
      <AuthUserContext.Consumer>
        {authUser => (
          <div>
            ...
            {messages ? (
              <MessageList messages={messages.map(message => ({
                  ...message,
                  user: users ? users[messages.userId] : { userId: message.userId }
                }))}
